...
/**
 * Password-reset request from an e-mailed link (SPEC-0002 BR10). The new password is policy-validated
 * server-side ({@code PasswordPolicy}); only shape validation lives here.
 *
