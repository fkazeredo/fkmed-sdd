 ...
 * "verify your e-mail" message with a resend affordance (BR6); an unknown e-mail yields the neutral
 * not-found (BR7, no enumeration). Replaces the retired dev-login seam (SPEC-0001 BR8).
 */
@Service
